...
- Changed the animation of the TCR Hunter to the Seeker animation of vanilla
...
- Added support for joining public TCR lobbies using the "Find Game"-Button **on Modded Servers (only!)** | Thanks to [miniduikboot](https://github.com/miniduikboot)
...
- Fixed a bug where custom color names did not work (TCR is now compatible with colorblind mode)
...
- Added The Coust Roles changelog announcement popup
...
**Version 2.6.2**
- The Coust Roles now supports the new Among Us version **2021.5.10s**
