![eisbison banner](./Images/TCR_logo.png)
<p align="center"><a href="https://github.com/TheOtherRolesAU/TheOtherRoles/releases/"><img src="https://badgen.net/github/release/eisbison/theotherroles"></a></p>
...
[![Discord](./Images/TCR_server.png)](https://discord.gg/77RkMJHWsM)
![eisbison infographic](./Images/TCR_Roles.png)


# The Coust Roles

The **The Coust Roles** is a mod for [Among Us](https://store.steampowered.com/app/945360/Among_Us) which adds many new roles, new [Settings](#settings) and new [Custom Hats](#custom-hats) to the game.
...
| [Sund](#sund) | [Security Guard](#security-guard) |  |  |
| [Evil Guesser](#guesser) | [Medium](#medium) |  |  |
|  | [Trapper](#trapper) |  |  |
...
|----------|-------------|-----------------|
| 2024.11.26| v4.8.0| [Download](https://github.com/EdisonP-07/TheCoustRoles/releases/download/v4.8.0/The.Coust.Roles.v4.8.0.zip)
...
1. Download the newest [release](https://github.com/EdisonP-07/TheCoustRoles/releases/latest)
...
2. Download newest [release](https://github.com/EdisonP-07/TheCoustRoles/releases/latest) and extract it to ~/.steam/steam/steamapps/common/Among Us
3. Enable winhttp.dll via the proton winecfg (https://docs.bepinex.dev/articles/advanced/proton_wine.html)
4. Launch the game via Steam

## The Coust Roles Custom Servers
...
![TCR Colors](./Images/TCR_colors.jpg)
