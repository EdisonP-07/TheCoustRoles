...
namespace TheCoustRoles
{
    ...
    static class HudManagerStartPatch
    {
        ...
        public static void setCustomButtonCooldowns() {
            if (!initialized) {
                try {
                    ...
                    TheCoustRolesPlugin.Logger.LogWarning("Button cooldowns not set, either the gamemode does not require them or there's something wrong.");
                    return;
                }
            }
        ...
        public static void createButtonsPostfix(HudManager __instance) {
            ...
            arsonistButton = new CustomButton(
                ...
                () => {
                    ...
                    foreach (PlayerControl p in Arsonist.dousedPlayers) {
                        if (TCRMapOptions.playerIcons.ContainsKey(p.PlayerId)) {
                            TCRMapOptions.playerIcons[p.PlayerId].setSemiTransparent(false);
                        }
                    }
            ...
            propSpriteHolder = new GameObject("TCRPropButtonPropSpritePreview");
