...
namespace TheCoustRoles.CustomGameModes {
    public static class HideNSeek { // HideNSeek Gamemode
        ...
        public static void clearAndReload() {
            isHideNSeekGM = TCRMapOptions.gameMode == CustomGamemodes.HideNSeek;
    ...
    public static class Hunter {
        ...
        public static Sprite getArrowSprite() {
            ...
            buttonSpriteArrow = Helpers.loadSpriteFromResources("TheCoustRoles.Resources.HideNSeekArrowButton.png", 115f);
            return buttonSpriteArrow;
        }

        public static Sprite getLightSprite() {
            if (buttonSpriteLight) return buttonSpriteLight;
            buttonSpriteLight = Helpers.loadSpriteFromResources("TheCoustRoles.Resources.LighterButton.png", 115f);
