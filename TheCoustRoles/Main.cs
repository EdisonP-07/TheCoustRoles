...
using AmongUs.Data;
using TheCoustRoles.Modules.CustomHats;
using static TheCoustRoles.Modules.ModUpdater;
...
namespace TheCoustRoles
{
    ...
    public class TheCoustRolesPlugin : BasePlugin
    {
        public const string Id = "me.eisbison.TheCoustRoles";
        ...
        public static TheCoustRolesPlugin Instance;
        ...
        public override void Load() {
            ...
            // Reactor.Utilities.ReactorCredits.Register("TheCoustRoles", VersionString, betaDays > 0, location => location == Reactor.Utilities.ReactorCredits.Location.PingTracker);
            ...
            TheCoustRolesPlugin.Logger.LogInfo("Loading TCR completed!");
        }
    }
    ...
    public static class DebugManager
    {
        ...
        public static void Postfix(KeyboardJoystick __instance)
        {
            ...
            Byte[] hashed = sha.ComputeHash(Encoding.UTF8.GetBytes(TheCoustRolesPlugin.DebugMode.Value));
