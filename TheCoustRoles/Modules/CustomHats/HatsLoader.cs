...
using static TheCoustRoles.Modules.CustomHats.CustomHatManager;
...
public class HatsLoader : MonoBehaviour
{
    ...
    private IEnumerator CoFetchHats()
    {
        ...
        TheCoustRolesPlugin.Logger.LogMessage($"Download manifest at: {RepositoryUrl}/{ManifestFileName}");
        ...
        {
            TheCoustRolesPlugin.Logger.LogError(www.error);
            yield break;
        }
        ...
        TheCoustRolesPlugin.Logger.LogMessage($"I'll download {toDownload.Count} hat files");
    ...
    private static IEnumerator CoDownloadHatAsset(string fileName)
    {
        ...
        TheCoustRolesPlugin.Logger.LogMessage($"downloading hat: {fileName}");
        ...
        while (!persistTask.IsCompleted)
        {
            ...
            {
                TheCoustRolesPlugin.Logger.LogError(persistTask.Exception.Message);
                break;
            }
