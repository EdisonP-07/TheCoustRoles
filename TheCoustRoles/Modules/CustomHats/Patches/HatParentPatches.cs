...
using PowerTools;
using TheCoustRoles;
using TheCoustRoles.Modules.CustomHats.Extensions;
using UnityEngine;

namespace TheCoustRoles.Modules.CustomHats.Patches;
...
internal static class HatParentPatches
{
    ...
    private static bool SetCustomHat(HatParent hatParent)
    {
        ...
        {
            TheCoustRolesPlugin.Logger.LogWarning($"Unable to create test hat \n{err}");
            return true;
        }
