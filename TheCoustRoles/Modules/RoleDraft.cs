...
namespace TheCoustRoles.Modules
{
    ...
    class RoleDraft
    {
        public static bool isEnabled => CustomOptionHolder.isDraftMode.getBool() && (TCRMapOptions.gameMode == CustomGamemodes.Classic || TCRMapOptions.gameMode == CustomGamemodes.Guesser);
                ...
                while (timer < maxTimer || !picked) {
                    ...
                    if (PlayerControl.LocalPlayer.PlayerId == pickOrder[0]) {
                        ...
                        foreach (RoleInfo roleInfo in RoleInfo.allRoleInfos) {
                            ...
                            if (TCRMapOptions.gameMode == CustomGamemodes.Guesser && (roleInfo.roleId == RoleId.EvilGuesser || roleInfo.roleId == RoleId.NiceGuesser)) continue;
                        ...
                        if (availableRoles.Count == 0) {
                            ...
                            TheCoustRolesPlugin.Logger.LogWarning("Draft Mode: Fallback triggered, because no roles were left. Forced addition of basegame Imp/Crewmate");
                        }
        ...
        public static void receivePick(byte playerId, byte roleId)
        {
            ...
            catch (Exception e) { TheCoustRolesPlugin.Logger.LogError(e); }
        }
