...
namespace TheCoustRoles.Objects {
    public class Bomb {
        ...
        public static Sprite getBombSprite() {
            ...
            bombSprite = Helpers.loadSpriteFromResources("TheCoustRoles.Resources.Bomb.png", 300f);
            return bombSprite;
        }
        public static Sprite getBackgroundSprite() {
            if (backgroundSprite) return backgroundSprite;
            backgroundSprite = Helpers.loadSpriteFromResources("TheCoustRoles.Resources.BombBackground.png", 110f / Bomber.hearRange);
            return backgroundSprite;
        }

        public static Sprite getDefuseSprite() {
            if (defuseSprite) return defuseSprite;
            defuseSprite = Helpers.loadSpriteFromResources("TheCoustRoles.Resources.Bomb_Button_Defuse.png", 115f);
            return defuseSprite;
        }
        ...
        public static void explode(Bomb b) {
            ...
            if (Bomber.bomber != null) {
                ...
                try {
                    ...
                    TheCoustRolesPlugin.Logger.LogWarning($"Exception in Sound Effect for Bomb explosion: {e}");
                }
            }
            Bomber.clearBomb();
            canDefuse = false;
