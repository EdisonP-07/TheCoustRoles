...
namespace TheCoustRoles.Objects {
    public class CustomButton {
        ...
        public static KeyCode Action2Keycode = KeyCode.G; //TheCoustRolesPlugin.Instance.Config.Bind("Buttons", "Action2Keycode", KeyCode.G, "Second Ability Button Key").Value;
        public static KeyCode Action3Keycode = KeyCode.H; // TheCoustRolesPlugin.Instance.Config.Bind("Buttons", "Action3Keycode", KeyCode.H, "Third Ability Button Key").Value;
