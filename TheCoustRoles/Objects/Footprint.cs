...
namespace TheCoustRoles.Objects 
{
    public class FootprintHolder : MonoBehaviour {
        ...
        private static Sprite FootprintSprite => _footprintSprite ??= Helpers.loadSpriteFromResources("TheCoustRoles.Resources.Footprint.png", 600f);

        private static bool AnonymousFootprints => TheCoustRoles.Detective.anonymousFootprints;
        private static float FootprintDuration => TheCoustRoles.Detective.footprintDuration;
