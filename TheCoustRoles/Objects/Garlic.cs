...
namespace TheCoustRoles.Objects {
    class Garlic {
        ...
        public static Sprite getGarlicSprite() {
            ...
            garlicSprite = Helpers.loadSpriteFromResources("TheCoustRoles.Resources.Garlic.png", 300f);
            return garlicSprite;
        }
        ...
        public static Sprite getBackgroundSprite() {
            ...
            backgroundSprite = Helpers.loadSpriteFromResources("TheCoustRoles.Resources.GarlicBackground.png", 60f);
