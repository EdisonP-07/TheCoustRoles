...
using static TheCoustRoles.HudManagerStartPatch;
...
namespace TheCoustRoles
{
    ...
    public static void HandleShareOptions(byte numberOfOptions, MessageReader reader) {            
            try {
                ...
                TheCoustRolesPlugin.Logger.LogError("Error while deserializing options: " + e.Message);
            }
        }
        ...
        public static void shareGamemode(byte gm) {
            TCRMapOptions.gameMode = (CustomGamemodes) gm;
        ...
        public static void workaroundSetRoles(byte numberOfRoles, MessageReader reader)
        {
                ...
                {                   
                    ...
                    try {
                        ...
                        TheCoustRolesPlugin.Logger.LogError("Error while deserializing roles: " + e.Message);
                    }
            }
        ...
        public static void placeCamera(byte[] buff) {
            ...
            TCRMapOptions.camerasToAdd.Add(camera);
        }
        ...
        public static void sealVent(int ventId) {
            ...
            TCRMapOptions.ventsToSeal.Add(vent);
        }
        ...
        public static void setFirstKill(byte playerId) {
            PlayerControl target = Helpers.playerById(playerId);
            if (target == null) return;
            TCRMapOptions.firstKillPlayer = target;
        }
