    ...
    public class RoleInfo {
        ...
        public static List<RoleInfo> getRoleInfoForPlayer(PlayerControl p, bool showModifier = true) {
            ...
            if (infos.Count == count) {
                if (p.Data.Role.IsImpostor)
                    infos.Add(TCRMapOptions.gameMode == CustomGamemodes.HideNSeek || TCRMapOptions.gameMode == CustomGamemodes.PropHunt ? RoleInfo.hunter : RoleInfo.impostor);
                else
                    infos.Add(TCRMapOptions.gameMode == CustomGamemodes.HideNSeek ? RoleInfo.hunted : TCRMapOptions.gameMode == CustomGamemodes.PropHunt ? RoleInfo.prop : RoleInfo.crewmate);
            }
        ...
        public static async Task loadReadme() {
            if (ReadmePage == "") {
                ...
                HttpResponseMessage response = await client.GetAsync("https://raw.githubusercontent.com/TheCoustRolesAU/TheCoustRoles/main/README.md");
