...
namespace TheCoustRoles
{
    public static class SubmergedCompatibility
    {
        ...
        public static bool TryLoadSubmerged()
        {
            try
            {
                TheCoustRolesPlugin.Logger.LogMessage("Trying to load Submerged...");
            ...
            {
                TheCoustRolesPlugin.Logger.LogError(e);
            }
            return false;
        }
        ...
        public static void RepairOxygen() {
            ...
            try {
                ...
                TheCoustRolesPlugin.Logger.LogMessage("null reference in engineer oxygen fix");
            }
