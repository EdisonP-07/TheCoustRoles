...
namespace TheCoustRoles.Utilities;
...
public static class EventUtility {
    ...
    public static Sprite getKickButtonSprite() {
        ...
        kickButtonSprite = Helpers.loadSpriteFromResources("TheCoustRoles.Resources.EventKickButton.png", 115f);
    ...
    public static void Update() {
        //if (!isEnabled || AmongUsClient.Instance.GameState != InnerNet.InnerNetClient.GameStates.Started || TheCoustRoles.rnd == null || IntroCutscene.Instance) return;
